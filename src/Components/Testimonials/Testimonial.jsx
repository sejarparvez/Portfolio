...
const Testimonial = () => {
  ...
  return (
    <div className="flex flex-col py-12 items-center justify-center mt-16 relative md:mt-24" id="Testimonial">
        ...
        {clients.map((client, index) => {
          return (
            <SwiperSlide
             ...
             >
              <div className="h-48 p-3 flex flex-col items-center justify-evenly md:p-8 
              md:w-[30rem] bg-gray-600 border-[7px] border-solid border-[#32daff]
                rounded-[20px] ">
              <img className="h-20 w-20 md:h-24 md:w-24 rounded-full border-4 border-solid border-cyan-500" src={client.img} alt="img" />
