  ...
  return (
    <div className="flex flex-col md:pt-20 lg:flex-row lg:-mt-16">
      <div className="flex flex-col gap-2 lg:basis-[30rem] lg:mt-32">
        <span className=" text-3xl md:text-5xl font-bold" style={{ color: darkMode ? "white" : "" }}>
          Works For All These
        </span>
        <span className=" text-3xl md:text-5xl text-cyan-500 font-bold">Brands & Clients</span>
        <span className="py-4">
